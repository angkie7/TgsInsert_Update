...
public class EditDosenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage("Yakin mau simpan?")
                        .setNegativeButton("No", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(EditDosenActivity.this, "Batal Update",
    ...
    private void requestUpdateDosen(){
        ...
        progressDialog =  ProgressDialog.show(this, null, "Tunggu...",
                true, false);

        Call<Dosen> call =  service.update_dosen(edtId.getText().toString(),edtNama.getText().toString(),
                edtNidn.getText().toString(), edtAlamat.getText().toString(),edtEmail.getText().toString(),
                edtGelar.getText().toString(),"https://picsum.photos/200", "72170146");
        call.enqueue(new Callback<Dosen>() {
            ...
            public void onFailure(Call<Dosen> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditDosenActivity.this,"Kesalahan",Toast.LENGTH_SHORT);
            }
        });
    }
}