...
public class CreateMatkulActivity extends AppCompatActivity {
    ...
    private static final String[] hari = {"Senin","Selasa","Rabu","Kamis","Jum'at"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String>adapter = new ArrayAdapter<>(
                CreateMatkulActivity.this,android.R.layout.simple_spinner_item,hari);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner1.setAdapter(adapter);

        spinner2 = (Spinner)findViewById(R.id.spinnerSesi);
        ArrayAdapter<String>adapterSesi = new ArrayAdapter<>(
                CreateMatkulActivity.this,android.R.layout.simple_spinner_item,sesi);
