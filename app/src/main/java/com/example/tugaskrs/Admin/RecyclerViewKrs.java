...
public class RecyclerViewKrs extends AppCompatActivity {
    ...
    public void tambahData(){
        ...
        krsArrayList.add(new Krs("SI1","Ddp","Senin",
                "3","1","Katon Wijana","30"));

        krsArrayList.add(new Krs("SI2","Alpro Strukdat","Selasa",
                "3","1","Katon Wijana","30"));

        krsArrayList.add(new Krs("SI3","Progweb","Rabu",
                "3","1","Erick","30"));

        krsArrayList.add(new Krs("SI4","Progmob","Kamis",
                "3","1","Kadek","30"));
    }
}
