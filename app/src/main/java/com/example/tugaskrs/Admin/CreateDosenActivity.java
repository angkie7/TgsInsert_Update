...
public class CreateDosenActivity extends AppCompatActivity {
    ...
    private void requestInsertDosen(){
        ...
        progressDialog  =  ProgressDialog.show(
                this, null, "Tunggu...", true, false);

        Call<Dosen> call =  service.insert_dosen(edtNama.getText().toString(),edtNidn.getText().toString(),
                edtAlamat.getText().toString(),edtEmail.getText().toString(),edtGelar.getText().toString(),
                "https://picsum.photos/200", "72170146");

        call.enqueue(new Callback<Dosen>() {
            @Override
            public void onResponse(Call<Dosen> call, Response<Dosen> response) {
                progressDialog.dismiss();
                Toast.makeText(CreateDosenActivity.this,"Berhasil Masukan",Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<Dosen> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(CreateDosenActivity.this,"Kesalahan..",Toast.LENGTH_SHORT);
            }
        });
    }
}